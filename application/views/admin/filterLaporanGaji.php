    ...
    <div class="card mx-auto" style="width: 35%">
        ...
        <form>
            ...
            <div class="card-body">
                ...
                <?php if (count($gaji) > 0) { ?>
                    <a style="width:100%" href="<?php echo base_url('admin/laporanGaji/cetakLaporanGaji?bulan=' . $bulan), '&tahun=' . $tahun ?>" class="btn btn-success"><i class="fas fa-print"></i> Cetak Laporan Gaji Pegawai </a>
                <?php } else { ?>
