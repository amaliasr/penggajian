...
<script type="text/javascript">
    ...
    function modalApproval(id) {
        ...
        html_footer += '<button type="button" class="btn btn-primary" onclick="pengajuanCuti(' + id + ')">Kirim Approval</button>'
    ...
    function pengajuanCuti(id) {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>direktur/kelolaCuti/approvalCuti',
            type: 'POST',
            data: data,
            beforeSend: function() {},
            success: function(response) {
